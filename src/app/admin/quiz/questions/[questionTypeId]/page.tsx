...
import {
	CreateQuizQuestion,
	IQuestionAnswer,
} from '@/app/interfaces/questions.type';
...
import { createQuiz } from '@/api/quizizzQuestion';
...
export default function QuestionCreate() {
	...
	const { mutate } = useMutation({
		mutationFn: (body: CreateQuizQuestion) => createQuiz(body),
	});
	/* submit form */
	const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
		e.preventDefault();
		const data: CreateQuizQuestion = {
			title: question,
		...
		<div className="bg-[#424242] min-h-screen flex flex-col gap-4">
			...
			>
				...
				<div className="h-10 mt-auto bg-[#222222] text-white flex justify-between items-center p-2">
					...
					<div className="flex items-center gap-2">
						<Link href="/admin/quiz/edit/quizEditId" className="inline-block">
							<button
								type="button"
